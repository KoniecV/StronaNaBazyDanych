...
bucket = "BazyDanych"
org = "school"
token = "fRZogsUW1ZFe4XMXw9ACHmqBf68gplQs2J85oKu5PSn2TRdvoR0WmRu6g9SAAn1T--BCkKjj4hSHLFowNS_dUw=="
...
def profile():
    if 'user' in session:
        ...
        conn = connect_db()
        cursor = conn.cursor()
        cursor.execute("SELECT iduzytkownika, nazwa, email, zweryfikowany FROM uzytkownik WHERE iduzytkownika = %s;",
                       (user_id,))
